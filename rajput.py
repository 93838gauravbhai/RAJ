...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        ...
        f"👉 [Click Here to Join](https://t.me/myqrcod1xv)\n"
        "After joining the channel, click 'I Have Joined' to proceed."
    )
    
    keyboard = [
        [InlineKeyboardButton("📢 Join Channel", url=f"https://t.me/myqrcod1xv")],
...
async def genkey(update: Update, context: CallbackContext):
    if update.callback_query:  # Check if called from a button click
        ...
        if user_id in ADMIN_IDS:
            ...
            await context.bot.send_message(user_id, "ONLY OWNER CAN USE💀OWNER @GAURAV_BHAI1")
        ...
        if user_id in ADMIN_IDS:
            ...
            response = "ONLY OWNER CAN USE💀OWNER @GAURAV_BHAI1"
...
BOT_TOKEN = '7567349538:AAEgRwaWf-YtCtHRB_BSdj0IrfrArAF7fks'
CHANNEL_USERNAME = '@myqrcod1xv'
ADMIN_IDS = ['6539807903']  # Admin user IDs
